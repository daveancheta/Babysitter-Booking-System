                ...
                <div className="grid gap-4 md:grid-cols-1 lg:grid-cols-4">
                    <div className='dark:bg-neutral-900 bg-background min-h-[200px] rounded-md p-7 shadow-lg flex flex-col gap-2 border'>
                        <div className='flex justify-between items-center'>
                            ...
                            <Badge variant='secondary' className='rounded-lg border dark:border-neutral-700 border-neutral-400'>
                        ...
                        <div className='mt-5 space-y-1'>
                            <span className='text-sm font-medium flex flex-row gap-1 items-center text-green-600 dark:text-green-400'>
                                Trending up this month <TrendingUp className="size-4" />
                            </span>
                            <span className='text-sm text-muted-foreground font-medium flex flex-row gap-1 items-center'>
