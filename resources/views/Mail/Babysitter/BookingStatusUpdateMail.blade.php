...
$parent = DB::table('bookings')
->leftJoin('users', 'bookings.user_id', '=', 'users.id')
->where('bookings.user_id', $bookings->user_id)
->first();
                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding:20px;">
                            <p style="margin:0 0 10px;">Hi {{ $parent->name }},</p>
                            <p style="margin:0 0 20px;">
                                This is an automated booking status update notice — please do not reply.
                            </p>
                        </td>
                    </tr>
                        ...
                        <td style="padding:0 20px 20px;">
                            <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="padding:8px; text-align:right; color: #008000; font-weight: bold; text-transform: capitalize;">
                                        {{ $bookings->status}}</td>
                                    ...
                                    @else
                                    <td
                                        style="padding:8px; text-align:right; color: #ff0000; font-weight: bold; text-transform: capitalize;">
                                        {{ $bookings->status }}</td>
                                    @endif
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding:8px; text-align:right; text-transform: capitalize;">Per {{
                                        $bookings->payment_method }}</td>
                                </tr>
                                <tr>
